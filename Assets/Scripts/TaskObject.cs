...
public class TaskObject : MonoBehaviour
{
    ...
    public void UpdateGUI()
    {
        ...
        rect.anchoredPosition = new Vector3((rect.sizeDelta.x * ((float) m_StartTime / (float)m_JobShopSchedulerObject.jsd.BestMakespan)), 0) + new Vector3(75, 0, 0);
        rect.sizeDelta = new Vector2(rect.sizeDelta.x * ((float) m_Duration / (float) m_JobShopSchedulerObject.jsd.BestMakespan), parentRect.rect.height);
